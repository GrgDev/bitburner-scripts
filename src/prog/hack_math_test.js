...
export async function main(ns) {
	...
	if (ns.args.length == 0) {
		...
		targetServer.moneyMax = 48_000_000.00;
	...
	const singleThreadGrowPercent = (hf.growPercent(targetServer, 1, testPlayer, 1)) - (targetServer.moneyAvailable / targetServer.moneyMax);
